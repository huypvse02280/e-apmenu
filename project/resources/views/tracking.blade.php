                  ...
                  <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        {!! Form::text('startTime', date("Y/m/d 00:00"), ['id' => 'filter-start-time','class' => 'form-control', 'placeholder' => date('Y/m/d 00:00:00')]) !!}
                      </div>
                      <div class="form-group col-md-6">
...
<script src="{{asset('build/js/MainUserTracking.js')}}"></script>
@endsection
